...
class merchantProfileProvider with ChangeNotifier {
  ...
  Future<void> fetchUserProfile() async {
    ...
    if (currentUser != null) {
      ...
      _user = User(
        ...
        gender:  '',
        location: userData['BranchLocation'] ?? '',
        year:  '',
  ...
  Future<void> updateProfile(User updatedUser) async {
    final currentUser = _auth.currentUser;
    if (currentUser != null) {
      await _firestore.collection('merchants').doc(currentUser.uid).update({
        'fullName': updatedUser.fullname,
        'image': updatedUser.image,
       // 'gender': updatedUser.gender,
        'BranchLocation': updatedUser.location,
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    context.read<merchantProfileProvider>().fetchUserProfile();
  }

  @override
  Widget build(BuildContext context) {
    final userProfile = context.watch<merchantProfileProvider>().user;
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: ()async{
                          ...
                          await context.read<merchantProfileProvider>().updateProfile(updatedUser);
                        },
                        child: Container(
                          width: 22,
                          height: 22,
